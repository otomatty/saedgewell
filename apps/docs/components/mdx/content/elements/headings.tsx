...
export function Heading({ children, level, ...props }: HeadingProps) {
  ...
  const classNames = {
    ...
    3: 'text-xl font-semibold mt-8 mb-3 group scroll-mt-28',
    4: 'text-lg font-semibold mt-6 mb-2 group scroll-mt-28',
    5: 'text-base font-semibold mt-5 mb-2 group scroll-mt-28',
    6: 'text-sm font-semibold mt-4 mb-2 group scroll-mt-28',
  };

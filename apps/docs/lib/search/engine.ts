...
export class SearchEngine {
  ...
  private flexSearchIndex: Document<IndexEntry, true> | null = null;
   ...
   * FlexSearchインデックスを取得
   */
  private async getFlexSearchIndex(): Promise<Document<IndexEntry, true>> {
    ...
    try {
      ...
      this.flexSearchIndex = new Document<IndexEntry, true>({
        tokenize: 'forward',
        document: {
          id: 'id',

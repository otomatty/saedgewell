...
import { snakeToCamel } from "@saedgewell/utils";
import type { BlogPost, BlogCategory } from "@saedgewell/types";
...
export async function getPublishedSlugsForBuild() {
	...
	const { getSupabaseConfig } = await import("@saedgewell/lib/server");
